...
const SocialMediaPromotion = () => {
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (editingItem) {
          ...
          res = await dispatch(createSocialMediaPromotion(formData));
          if (res?.status === 200) {
  ...
  const handleDeleteItem = async (item) => {
    try {
      const res = await dispatch(deleteSocialMediaPromotion(item._id, "", ""));
      if (res?.status === 200) {
  ...
  return (
    <>
      <Pageheader
        mainheading="Social Media Promotion"
        parentfolder="Home"
        activepage="Social Media Promotion"
      />
      <Row className="mt-5 row-sm">
        <Col md={12} lg={12} xl={12}>
          <Card className="custom-card transcation-crypto">
            <Card.Header className="border-bottom-0">
              {/* <div className="card-title">Social Media Promotion</div> */}
            </Card.Header>
            <Card.Body>
                    ...
                    return (
                      ...
                      >
                        <div className="premium-country-card">
                          <Link
                            to={`/socialmediapromotion-details/${item._id}`}
                          ...
                          >
                            ...
                            <div className="country-card-content">
                              ...
                              <div className="country-card-doc-count">
                                ...
                                />
                                <span>
                                  {item?.documents?.length || 0} Promotions
                                </span>
                              </div>
                            </div>
                          </Link>

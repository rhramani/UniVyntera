...
import { getAllbranchPerformanceReport } from "../../../redux/actions/Report/OverallReports.action";
...
const BranchPerformanceReport = () => {
  ...
  const { canRead, canDownload } = usePermissions("Branch Performance");
  ...
  const fetchBranchPerformanceReports = async (
    page = 1,
    limit = itemsPerPage,
    search = ""
  ) => {
    try {
      ...
      setBranchPerformanceData(res?.data?.data?.message?.data || []);
  ...
  useEffect(() => {
    if (canRead) {
      fetchBranchPerformanceReports(currentPage, itemsPerPage, search);
    }
  ...
  const handleExport = async () => {
    try {
      ...
      toast.success("Branch Performance report downloaded successfully!");
    } catch (error) {
  ...
  return (
    <>
      <Pageheader
        mainheading="Branch Performance"
        parentfolder="Reports"
        activepage="Branch Performance"
      />
        ...
        <Col md={12} lg={12} xl={12}>
          <Card className="custom-card transcation-crypto">
            <Card.Header className="border-bottom-0">
              <div className="w-100 d-flex flex-wrap justify-content-between">
                <div className="d-flex justify-content-between">
                  <div className="card-title">Branch Performance Report</div>
                </div>
                ...
                {branchPerformanceData?.length > 0 && canDownload && (
                  <Button
                    variant="primary"
            ...
            <Card.Body>
              ...
              {totalPages > 1 && branchPerformanceData.length > 0 && (

...
const NavsTabs = () => {
  return (
    <Fragment>
      <Pageheader mainheading='Navs & tabs' parentfolder='Elements' activepage='Navs & tabs' />
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav className="nav nav-pills justify-content-center nav-style-2 mb-3" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" href="#home-center">Home</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="second" href="#about-center" >About</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="third" href="#services-center">Services</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="fourth" href="#contacts-center">Contacts</Nav.Link> </Nav.Item>
                </Nav>
                <Tab.Content id="myTabContent">
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav className="nav nav-pills justify-content-end nav-style-3 mb-3" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" href="#home-right">Home</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="second" href="#about-right">About</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="third" href="#services-right">Services</Nav.Link></Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="fourth" href="#contacts-right">Contacts</Nav.Link> </Nav.Item>
                </Nav>
                <Tab.Content id="myTabContent">
                  <Tab.Pane role="tabpanel" eventKey="first">
                    How travel coupons make you a better lover. Why cultural solutions are the new
          ...
          <Card className="custom-card">
            <Tab.Container defaultActiveKey="first">
              <Card.Header className=" justify-content-between">
                ...
                <div>
                  <Nav className="nav-tabs justify-content-end nav-tabs-header mb-0" role="tablist" defaultActiveKey="first">
                    <Nav.Item> <Nav.Link eventKey="first" href="#home-header">Home</Nav.Link></Nav.Item>
                    <Nav.Item> <Nav.Link eventKey="second" href="#about-header">About</Nav.Link> </Nav.Item>
                    <Nav.Item> <Nav.Link eventKey="third" href="#services-header">Services</Nav.Link> </Nav.Item>
                  </Nav>
                </div>
              </Card.Header>
              <Card.Body>
                <Tab.Content>
                  <Tab.Pane className="text-muted" id="home-header" eventKey="first" role="tabpanel">
                    <ul className="mb-0">
                      <li className="mb-2">
                        How hotel deals can help you live a better life. <b>How celebrity
                          cruises</b> aren't as bad as you think. How cultural solutions
                  ...
                  <Tab.Pane className="text-muted" id="about-header" eventKey="second" role="tabpanel">
                    <ul className="mb-0">
                      <li className="mb-2">
                        How travel coupons make you a better lover. Why cultural solutions
                        are the new black. Why mom was header about travel insurances. How
                  ...
                  <Tab.Pane className="text-muted" id="services-header" eventKey="third" role="tabpanel">
                    <ul className="mb-0">
                      <li className="mb-2">
          ...
          <Card className="custom-card">
            <Tab.Container defaultActiveKey="first">
              ...
              <Card.Body>
                <Tab.Content>
                  <Tab.Pane
                    className="text-muted" id="home-footer" role="tabpanel" eventKey="first">
                    How travel coupons make you a better lover. Why cultural solutions are the new
                    black. Why mom was right about travel insurances. How family trip ideas can help
                    you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                    you'll never succeed at daily deals. 11 ways cheapest flights can find you the
                  ...
                  <Tab.Pane className="text-muted" id="about-footer" role="tabpanel" eventKey="second">
                    How hotel deals can help you live a better life. <b> How celebrity cruises </b>
                    aren't as bad as you think. How cultural solutions can help you predict the
                    future. How to cheat at dog friendly hotels and get away with it. 17 problems
                    with summer activities. How to cheat at travel agents and get away with it. How
                  ...
                  <Tab.Pane className="text-muted" id="services-footer" role="tabpanel" eventKey="third">
                    Unbelievable healthy snack success stories. 12 facts about safe food handling
                    tips that will impress your friends. Restaurant weeks by the numbers. Will
                    mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                    How restaurant weeks can make you sick. The complete beginner's guide to cooking
              ...
              <Card.Footer>
                <Nav className="nav-tabs justify-content-end nav-tabs-footer mb-0" defaultActiveKey="first">
                  <Nav.Item className="m-1"> <Nav.Link eventKey="first" href="#home-footer">Home</Nav.Link> </Nav.Item>
                  <Nav.Item className="m-1"> <Nav.Link eventKey="second" href="#about-footer">About</Nav.Link> </Nav.Item>
                  <Nav.Item className="m-1"> <Nav.Link eventKey="third" href="#services-footer">Services</Nav.Link> </Nav.Item>
                </Nav>
              </Card.Footer>
            </Tab.Container>
          </Card>
      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <nav>
                  <Nav variant="pills" className="nav-tabs nav-justified tab-style-4 d-flex" id="myTab2" role="tablist" defaultActiveKey="first">
                ...
                <Tab.Content id="tab-style-4">
                  <Tab.Pane id="nav-home1" role="tabpanel" eventKey="first" aria-labelledby="nav-home-tab" tabIndex={0}>
                    <b>Lorem Ipsum is simply dummy</b> text of the printing and typesetting
                    industry. Lorem Ipsum has been the industry's standard dummy text ever since the
                    1500s, when an unknown printer took a galley of type and scrambled it to make a
                  ...
                  <Tab.Pane id="nav-profile1" role="tabpanel" eventKey="second" aria-labelledby="nav-profile-tab" tabIndex={0}>
                  ...
                  <Tab.Pane id="nav-contact1" role="tabpanel" eventKey="third" aria-labelledby="nav-contact-tab" tabIndex={0}>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <Nav variant="pills" className="nav-pills mb-3 nav-justified tab-style-5 d-sm-flex d-block" id="pills-tab" role="tablist" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" id="pills-home-tab" type="button">Home</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="second" id="pills-profile-tab" type="button">About</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="third" id="pills-contact-tab" type="button">Services</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="fourth" id="pills-disabled-tab" type="button">Contacts</Nav.Link> </Nav.Item>
                </Nav>
                <Tab.Content id="pills-tabContent">
                  <Tab.Pane className="tab-pane show  text-muted" id="pills-home" role="tabpanel" eventKey="first" aria-labelledby="pills-home-tab" tabIndex={0}>
                    It is a long established fact that a reader will be distracted by the readable
                    content of a page when looking at its layout. The point of using Lorem Ipsum is
                    that it has a more-or-less normal distribution of letters, as opposed to using
                    'Content here, content here', making it look like readable English. <b>Many
                  ...
                  <Tab.Pane className="tab-pane text-muted" id="pills-profile" role="tabpanel" eventKey="second" aria-labelledby="pills-profile-tab" tabIndex={0}>
                    <b>Lorem Ipsum is simply dummy</b> text of the printing and typesetting
                    industry. Lorem Ipsum has been the industry's standard dummy text ever since the
                    1500s, when an unknown printer took a galley of type and scrambled it to make a
                    type specimen book. It has survived not only five centuries, but also the leap
                  ...
                  <Tab.Pane className="tab-pane text-muted" id="pills-contact" role="tabpanel" eventKey="third" aria-labelledby="pills-contact-tab" tabIndex={0}>
                    There are many variations of passages of Lorem Ipsum available, but the majority
                    have suffered alteration in some form, by injected humour, or randomised words
                    which don't look even slightly believable. <b>If you are going</b> to use a
                    passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing
                  ...
                  <Tab.Pane className="tab-pane text-muted" id="pills-disabled" role="tabpanel" eventKey="fourth" aria-labelledby="pills-disabled-tab" tabIndex={0}>
      ...
      <Row className="row-sm">
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <Nav as="ul" variant="" className="nav-tabs mb-3 tab-style-6" id="myTab" role="tablist" defaultActiveKey="first">
                  <Nav.Item as="li"> <Nav.Link eventKey="first" id="products-tab" type="button" ><i className="ri-gift-line me-1 align-middle d-inline-block"></i>Products</Nav.Link> </Nav.Item>
                  <Nav.Item as="li"> <Nav.Link eventKey="second" id="sales-tab" type="button"><i className="ri-bill-line me-1 align-middle d-inline-block"></i>Sales</Nav.Link> </Nav.Item>
                  <Nav.Item as="li"> <Nav.Link eventKey="third" id="profit-tab" type="button"><i className="ri-money-dollar-box-line me-1 align-middle d-inline-block"></i>Profit</Nav.Link> </Nav.Item>
                  <Nav.Item as="li"> <Nav.Link eventKey="fourth" id="expenses-tab" type="button" ><i className="ri-exchange-box-line me-1 align-middle d-inline-block"></i>Expenses</Nav.Link> </Nav.Item>
                </Nav>
                      ...
                      <table className="table mb-0">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row">
                              <span className="avatar avatar-sm">
                                <img src={ALLImages('ecommerce3')} alt="img" />
                              </span>
                            </th>
                            <td>Stop Watch</td>
                            <td>Clocks</td>
                          ...
                          <tr>
                            <th scope="row">
                              <span className="avatar avatar-sm">
                                <img src={ALLImages('ecommerce4')} alt="img" />
                              </span>
                            </th>
                            <td>Camera</td>
                            <td>Gadgets</td>
                          ...
                          <tr>
                            <th scope="row">
                              <span className="avatar avatar-sm">
                                <img src={ALLImages('ecommerce6')} alt="img" />
                              </span>
                            </th>
                            <td>Shoes</td>
                            <td>Footwear</td>
          ...
          <Card className="custom-card">
            ...
            <Card.Body className="d-flex align-items-start">
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Row>
                  <Col md={2}>
                    <Nav variant="pills" className="flex-column nav-pills me-3 tab-style-7" role="tablist" defaultActiveKey="third">
                      <Nav.Link eventKey="first" className=" text-start " id="main-profile-tab" type="button" ><i className="ri-shield-user-line me-1 align-middle d-inline-block"></i>Profile</Nav.Link>
                      <Nav.Link eventKey="second" className=" text-start" id="man-password-tab" type="button"><i className="ri-u-disk-line me-1 align-middle d-inline-block"></i>Password</Nav.Link>
                      <Nav.Link eventKey="third" className=" text-start" id="main-team-tab" type="button" ><i className="ri-group-line me-1 align-middle d-inline-block"></i>Team</Nav.Link>
                      <Nav.Link eventKey="fourth" className=" text-start" id="main-billing-tab"><i className="ri-bill-line me-1 align-middle d-inline-block"></i>Billing</Nav.Link>
                      <Nav.Link eventKey="fivith" className=" text-start mb-1" id="main-email-tab" type="button" ><i className="ri-mail-line me-1 align-middle d-inline-block"></i>Email</Nav.Link>
                    </Nav>
                  </Col>
                  <Col md={8}>
                        ...
                        <div className="d-sm-flex">
                          ...
                          <div>
                            <div className="my-md-auto mt-4 ms-md-3">
                              <h5 className="mb-1 pb-0">Adam Smith</h5>
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Row>
                  ...
                  <Col md={9}>
                    <Tab.Content>
                      <Tab.Pane className="text-muted" id="home-vertical-custom" eventKey="first" role="tabpanel">
                        <ul className="mb-0">
                          <li className="mb-2">
                            How hotel deals can help you live a better life. <b>How celebrity
                              cruises</b> aren't as bad as you think. How cultural solutions
                      ...
                      <Tab.Pane className="text-muted" id="about-vertical-custom" eventKey="second" role="tabpanel">
                        <ul className="mb-0">
                          <li className="mb-2">
                      ...
                      <Tab.Pane className="text-muted" id="services-vertical-custom" eventKey="third" role="tabpanel">
                        <ul className="mb-0">
                          <li className="mb-2">
                            There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.
                          </li>
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Row>
                  <Col md={4}>
                    <Nav className="nav-tabs flex-column vertical-tabs-3" role="tablist" defaultActiveKey="first">
                      <Nav.Item> <Nav.Link href="#employee-vertical" eventKey="first"> <i className="ri-map-pin-user-line me-2 align-middle d-inline-block"></i>Employees</Nav.Link> </Nav.Item>
                      <Nav.Item> <Nav.Link eventKey="second" href="#customers-vertical"> <i className="ri-group-line me-2 align-middle d-inline-block"></i>Customers</Nav.Link> </Nav.Item>
                      <Nav.Item> <Nav.Link href="#products-vertical" eventKey="third" className="mb-0" > <i className="ri-gift-line me-2 align-middle d-inline-block"></i>Products</Nav.Link> </Nav.Item>
                    </Nav>
                  </Col>
                  <Col md={8}>
                    <Tab.Content>
      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav variant='' className="nav nav-tabs mb-3" role="tablist" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" href="#hometab-dropdown" aria-selected="true">Home</Nav.Link> </Nav.Item>
                  <Dropdown className="nav-item dropdown">
                    <Dropdown.Toggle className="nav-link" variant=''>Company</Dropdown.Toggle>
                    <Dropdown.Menu >
                      <Dropdown.Item href="#homeabout-dropdown" eventKey="second" aria-selected="false">About</Dropdown.Item>
                  ...
                  <Nav.Item> <Nav.Link eventKey="third" href="#homeproducts-dropdown">Products</Nav.Link>
                  </Nav.Item>
                  <Nav.Item> <Nav.Link disabled> Services</Nav.Link> </Nav.Item>
                </Nav>
                <Tab.Content>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body className='pills-with-dropdowns'>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav variant='pills' className="nav-pills mb-3" role="tablist" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" href="#pill-products">Products</Nav.Link> </Nav.Item>
                  <Dropdown className=''>
                    <Dropdown.Toggle as='a' variant='' className='nav-link' aria-expanded="false">Cart</Dropdown.Toggle>
                    <Dropdown.Menu>
                      <Dropdown.Item data-bs-toggle="tab" role="tab" href="#pill-wishlist" eventKey="second" aria-selected="false">Wishlist</Dropdown.Item>
                  ...
                  <Nav.Item> <Nav.Link eventKey="third" href="#pill-orders">Orders</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link disabled> Offers</Nav.Link> </Nav.Item>
                </Nav>
                <Tab.Content>
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav variant='pills' className="nav nav-pills nav-fill mb-3" role="tablist" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" href="#fill-pill-home">Home</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="second" href="#fill-pill-about">Customer-ratings</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="third" href="#fill-pill-services">Services</Nav.Link> </Nav.Item>
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav variant='pills' className="nav nav-pills nav-justified mb-3 d-sm-flex d-block" role="tablist" defaultActiveKey="first">
                  <Nav.Item> <Nav.Link eventKey="first" href="#justified-pill-home">Home</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="second" href="#justified-pill-details">Company Details</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link eventKey="third" href="#justified-pill-products">Products</Nav.Link> </Nav.Item>
                  <Nav.Item> <Nav.Link disabled> Disabled</Nav.Link> </Nav.Item>
                </Nav>
                <Tab.Content>
      ...
      <Row className="row-sm">
        <Col xl={12}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav variant='pills' className="flex-column flex-sm-row" role="tablist" defaultActiveKey="first">
                  <Nav.Link className="flex-sm-fill text-sm-center" eventKey="first" href="#pill-flex-home">Home</Nav.Link>
                  <Nav.Link className="flex-sm-fill text-sm-center" eventKey="second" href="#pill-flex-big">More Data More The Tab Size</Nav.Link>
                  <Nav.Link className="flex-sm-fill text-sm-center" eventKey="third" href="#pill-flex-about">About</Nav.Link>

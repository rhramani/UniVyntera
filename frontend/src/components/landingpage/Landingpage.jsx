          ...
          <header className="app-header">
            <div className="main-header-container container-fluid">
              <div className="header-content-left">
                ...
                <div className="header-element">
                  <Link to="#" className="sidemenu-toggle header-link" ><span className="open-toggle"> <i className="ri-menu-3-line fs-20"></i> </span></Link>
                </div>
              </div>
              <div className="header-content-right">
                <div className="header-element align-items-center">
                  <div className="btn-list d-lg-none d-block">
                    <Link to={`${import.meta.env.BASE_URL}firebase/firebaseregistration`} className="btn btn-primary-light">New User</Link>
                    <Link to={`${import.meta.env.BASE_URL}firebase/firebasesignin`} className="btn btn-primary-light">Login</Link>
                  </div>
                </div>
              </div>
            </div>
                ...
                <nav className="main-menu-container nav nav-pills sub-open">
                  <div className="landing-logo-container">
                    <div className="horizontal-logo">
                      <Link to={`${import.meta.env.BASE_URL}dashboard/dashboard`} className="header-logo">
                        ...
                        <img src={ALLImages('logo3')} alt="logo" className="desktop-white" />
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="d-lg-flex d-none">
                    <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                      <Link to={`${import.meta.env.BASE_URL}firebase/firebaseregistration`} className="btn btn-wave btn-secondary">New User</Link>
                      <Link to={`${import.meta.env.BASE_URL}firebase/firebasesignin`} className="btn btn-wave btn-info">Login</Link>
                    </div>
                  </div>
                </nav>
              </div>
              ...
              <div className="container main-banner-container">
                <Row>
                  <Col xl={6} lg={6} className="animation-zidex position-relative">
                    ...
                    <p className="text-start fw-bold">We Help to Build Your Dream Project with React Spruha-JS !</p>
                    <h6 className="pb-3">
                      Spruha-JS  Now you can use this React admin template to design stunning dashboards
                    ...
                    <div className="btn-list">
                      <Link to="https://react.spruko.com/spruha-js/preview" target="_blank" className="btn btn-sm btn-w-sm mb-3 me-2 btn-light"><i className="fe fe-play me-2"></i> Get Started</Link>
                      <Link to="https://themeforest.net/user/spruko/portfolio" className="btn btn-sm btn-w-sm btn-outline-light mb-3 me-2 text-white" target="_blank"><i className="fe fe-eye me-2"></i>Discover More</Link>
                    </div>
                  </Col>
                  <Col xl={6} lg={6} className="my-auto">
                    <img src={ALLImages("landing4")} alt="" />
                  </Col>
                </Row>
              </div>
            </section>
          ...
          <section className="section hor-content main_features" id="features">
            <Container>
              <div>
                ...
                <h2 className="fw-medium text-center">Spruha-JS react Main Features</h2>
                                          ...
                                          <div className="counter-status">
                                            ...
                                            <div className="test-body text-center text-fixed-white">
                                              ...
                                              <div className="counter-text">
                                                <h5 className="fw-normal mb-0">React components</h5>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div className="bg-transparent">
                                          <div className="counter-status">
                                            ...
                                            <div
                                              ...
                                              <div className="counter-text">
                                                <h5 className="fw-normal mb-0">React integrated Plugins</h5>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
...
C431.3,1830.2,378.4,1777.3,378.4,1712z" />
          ...
          <section className="section landing-Features">
            <Container className="text-center">
              ...
              <h4 className="fw-medium mb-2 text-fixed-white ">Features Used in Spruha-JS react Admin Template</h4>
              <div className="text-start mt-5">
                <div className="justify-content-center">
                  <div className="">
                    <Swiper rewind={true} loop={true} centeredSlides={true} autoplay={true}
                      ...
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web1')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">React</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web2')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">React-Bootstrap</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web3')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">vite</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web4')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">Typescript</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web5')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">css3</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web6')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">sass</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web7')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">NPM</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web8')} alt="image" className="featur-icon" />
                          <h5 className="mt-3 text-fixed-white ">Yarn</h5>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="ms-sm-5 ms-3 text-center">
                          <img src={ALLImages('web9')} alt="image" className="featur-icon" />
          ...
          <section className="section highlights" id="highlights">
            <Container className="text-center">
              ...
              <Row className="justify-content-center">
                <Col xl={7}>
                  <p className="fs-15 mb-5 fw-normal">The Spruha–JS react-bootstrap Admin & Dashboard
                    ...
                    <Col xl={6}>
                      <Accordion className="accordion-customicon1 accordion-primary accordions-items-seperate" defaultActiveKey="accordionFAQ1">
                        <Accordion.Item className="acc-primary" eventKey="accordionFAQ1">
                          ...
                          <Accordion.Body>
                            The Spruha–JS React Bootstrap Admin & Dashboard Template is available in both vertical and horizontal menus.
                        ...
                        <Accordion.Item className="acc-secondary" eventKey="accordionFAQ2">
                          ...
                          <Accordion.Body>
                            The Spruha–JS React Bootstrap Admin & Dashboard Template is available in LTR & RTL versions with single assets.
                        ...
                        <Accordion.Item className="acc-success" eventKey="accordionFAQ3">
                          ...
                          <Accordion.Body>
                            The Spruha–JS React Bootstrap Admin & Dashboard Template is available in different types of color styles.
                    ...
                    <Col xl={6}>
                      <Accordion className="accordion-customicon1 accordion-primary accordions-items-seperate" defaultActiveKey="accordionFAQ6">
                        <Accordion.Item className="acc-info" eventKey="accordionFAQ4">
                          ...
                          <Accordion.Body>
                            The Spruha–JS React Bootstrap Admin & Dashboard Template is also available in two different types of layouts
                        ...
                        <Accordion.Item className="acc-danger" eventKey="accordionFAQ5">
                          ...
                          <Accordion.Body>
                            The Spruha–JS React Bootstrap Admin & Dashboard Template is also available in different types of Side Menu Styles.
                        ...
                        <Accordion.Item className="acc-warning" eventKey="accordionFAQ6">
                          ...
                          <Accordion.Body>
                            The Spruha–JS React Bootstrap Admin & Dashboard Template is also available in two different types of layouts "Fixed Layout" and
                        ...
                        <Row className="d-flex align-items-center justify-content-center">
                          ...
                          <Col lg={4} xl={4} md={8} sm={12}>
                            <Card className="pricing-card">
                              ...
                              <div className="card-footer text-center border-top-0 py-3 d-grid">
                                <Button size="lg" className="btn-outline-danger">
                                  <span className="ms-4 me-4">Select</span>
                                </Button>
                              </div>
                            </Card>
              ...
              <Row>
                ...
                <Row className="align-items-center">
                  ...
                  <Col md={12} lg={6} className="reveal revealright">
                    <img src={ALLImages('landing3')} alt="" />
                  </Col>
                </Row>
              </Row>
            </Container>
              ...
              <div className="p-2 mb-0">
                <Card.Body className="p-0">
                    ...
                    <Row>
                      ...
                      <Col lg={2} sm={6} md={4} className="reveal revealleft position-relative">
                        ...
                        <ul className="mb-5 mb-lg-0 ps-0">
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}dashboard/dashboard/`}>Dashboard</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}elements/accordions/`}>Elements</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}forms/formelements/inputs/`}>Forms</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}charts/apexchart/linechart/`}>Charts</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}apps/tables/tables/`}>Tables</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}dashboard/dashboard/`}>Other Pages</Link></li>
                        </ul>
                      </Col>
                      <Col lg={2} sm={6} md={4} className="reveal revealleft position-relative">
                        <h6>Information</h6>
                        <ul className="mb-5 mb-lg-0 ps-0">
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}pages/aboutus/`}>Our Team</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}advanceui/contacts/`}>Contact US</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}pages/aboutus/`}>About</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}pages/faq/`}>Services</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}apps/blog/blog/`}>Blog</Link></li>
                          <li><Link target="_blank" to={`${import.meta.env.BASE_URL}pages/faq/`}>Terms and Services</Link></li>
                        </ul>
                      </Col>
                      <Col lg={4} sm={12} md={4} className="reveal revealleft">
                        <div className="">
                          <Link to={`${import.meta.env.BASE_URL}dashboard/dashboard`}><img loading="lazy" alt="" className="logo mb-3" src={ALLImages('logo3')} /></Link>
                  ...
                  <footer className="main-footer px-0 text-center">
                    <Row>
                      <Col md={12} sm={12}> Copyright © <span id="year">{new Date().getFullYear()}</span> <Link to="#">Spruha</Link>.Designed with <span className="fa fa-heart text-danger"></span> by <Link to="#"> Spruko </Link> All rights reserved.</Col>
                    </Row>
                  </footer>
                </Card.Body>
              </div>

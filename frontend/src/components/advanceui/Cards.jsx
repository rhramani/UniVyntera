...
const Cards = () => {
  ...
  return (
    ...
    <Fragment>
      <Pageheader mainheading='Cards' parentfolder='Advanced UI' activepage='Cards' />
      ...
      <Row className="row-sm">
        <Col xl={4}>
          <Card className="custom-card">
            <img src={ALLImages("media29")} className="card-img-top" alt="..." />
            <Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={ALLImages("media28")} className="card-img-bottom" alt="..." />
          </Card>
        </Col>
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={ALLImages("media30")} className="card-img rounded-0" alt="..." />
            <Card.Body>
              <p className="card-text mb-0"><small>Last updated 3 mins
                ago</small></p>
            </Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={ALLImages("media31")} className="card-img rounded-0" alt="..." />
            <div className="card-footer">
              <p className="card-text mb-0"><small>Last updated 3 mins
                ago</small></p>
            </div>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <img src={ALLImages("media32")} className="card-img-top" alt="..." />
            <Card.Header>
              <div className="card-title">Image caps are widely used in Blog's</div>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={ALLImages("media33")} className="card-img-bottom" alt="..." />
          </Card>
        </Col>
      </Row>
      ...
      <Row className="row-sm">
        <Col xl={4}>
          <Card className="custom-card overlay-card">
            <img src={ALLImages("media35")} className="card-img" alt="..." />
        ...
        <Col xl={4}>
          <Card className="custom-card overlay-card">
            <img src={ALLImages("media36")} className="card-img" alt="..." />
        ...
        <Col xl={4}>
          <Card className="custom-card overlay-card">
            <img src={ALLImages("media34")} className="card-img" alt="..." />
            <div className="card-img-overlay d-flex flex-column p-0">
              <div className="card-header border-bottom-0">
                <div className="card-title text-fixed-white">
                  Image Overlays Are Awesome!
      ...
      <Row className="row-sm">
        <Col xl={4}>
          <Card className="custom-card">
            <Row className="g-0">
              <Col md={4}>
                <img src={ALLImages("media37")} className="img-fluid rounded-start h-100 w-100" alt="..." />
              </Col>
              <Col md={8}>
                <Card.Header>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Row className="g-0">
              ...
              <Col md={4}>
                <img src={ALLImages("media38")} className="img-fluid rounded-end h-100 w-100" alt="..." />
              </Col>
            </Row>
          </Card>
        </Col>
        <Col xl={4}>
          <Card className="custom-card">
            <Row className="g-0">
              ...
              <Col md={4}>
                <img src={ALLImages("media39")} className="img-fluid rounded-end h-100 w-100" alt="..." />
              </Col>
            </Row>
          </Card>
        </Col>
      ...
      <Row className="row-sm">
        <Col xl={12}>
          <div className="card-group">
            <Card className="custom-card">
              <img src={ALLImages("media40")} className="card-img-top" alt="..." />
              <Card.Body>
            ...
            <Card className="custom-card">
              <img src={ALLImages("media41")} className="card-img-top" alt="..." />
              <Card.Body>
            ...
            <Card className="custom-card">
              <img src={ALLImages("media42")} className="card-img-top" alt="..." />
              <Card.Body>
      ...
      <Row className="row-sm">
            ...
            <div className="col-xxl-7 col-xl-12">
              <Card className="custom-card">
                ...
                <Row className="g-0">
                  ...
                  <Col md={4}>
                    <img src={ALLImages("media39")} className="img-fluid rounded-end h-100" alt="..." />
                  </Col>
                </Row>
              </Card>
            </div>
        ...
        <div className="col-xxl-3 col-xl-6">
          <Card className="custom-card">
            <Link to="#" className="card-anchor"></Link>
            <img src={ALLImages("media47")} className="card-img-top" alt="..." />
            <Card.Body>
      ...
      <Row className="row-sm">
        <Col xl={12}>
          <Row className="row-cols-1 row-cols-md-4 g-4">
            <div className="col">
              <Card className="custom-card">
                <img src={ALLImages("media44")} className="card-img-top" alt="..." />
                <Card.Body>
            ...
            <div className="col">
              <Card className="custom-card">
                <img src={ALLImages("media43")} className="card-img-top" alt="..." />
                <Card.Body>
            ...
            <div className="col">
              <Card className="custom-card">
                <img src={ALLImages("media45")} className="card-img-top" alt="..." />
                <Card.Body>
                  <h6 className="card-title fw-semibold">Most tropical areas are suitable</h6>
                  <p className="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                </Card.Body>
            ...
            <div className="col">
              <Card className="custom-card">
                <img src={ALLImages("media46")} className="card-img-top" alt="..." />
                <Card.Body>

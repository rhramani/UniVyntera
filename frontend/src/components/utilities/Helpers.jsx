...
const Helpers = () => {
  return (
    <Fragment>
      <Pageheader mainheading='Helpers' parentfolder='Utilities' activepage='Helpers' />
      {/* <!-- Start:: row-1 --> */}
      <Row className="row-sm">
        <Col xxl={5} xl={5} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Colors With backgrounds </div>
            </Card.Header>
            <Card.Body>
        ...
        <Col xxl={4} xl={4} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title as="h6">With Other Components</Card.Title>
            </Card.Header>
            <Card.Body>
              ...
              <Card className="text-bg-secondary mb-3" style={{ maxWidth: "18rem" }}>
                <Card.Header className="border-bottom-0">
                  <Card.Title className="text-fixed-white" as="h6"> Header </Card.Title>
                </Card.Header>
                <Card.Body className="pt-0">
                  <p className="card-text text-fixed-white">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </Card.Body>
              </Card>
        ...
        <Col xxl={3} xl={3} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <img className="bd-placeholder-img card-img-top card-img" src={ALLImages('media35')} alt="..." />
              <Card.Body className="pb-0">
                <Card.Title as='h5'>Card with stretched links</Card.Title>
                <p className="card-text">
                  <Link to="#" className="stretched-link text-danger" style={{ position: "relative" }}>Stretched link will not work here, because <code>position: relative</code> is added to the link</Link>
                </p>
                <p className="card-text bg-light mb-0 p-1 rounded" style={{ transform: "rotate(0)" }}>
                  This <Link to="#" className="text-warning stretched-link"> stretched link </Link>
      ...
      <Row className="row-sm">
        <Col xxl={6} xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Clearfix </div>
            </Card.Header>
            <Card.Body>
              <div className="bg-light clearfix">
                <button type="button" className="btn btn-primary float-start m-1">Example Button floated left</button>
                <button type="button" className="btn btn-primary float-end m-1">Example Button floated right</button>
              </div>
            </Card.Body>
          </Card>
        </Col>
        <Col xxl={6} xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Colored links </div>
            </Card.Header>
            <Card.Body>
      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Ratio </div>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6}>
          <Row>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Custom ratios </div>
                </Card.Header>
                <Card.Body className="bd-example-ratios bd-example-ratios-breakpoint">
                  <div className="ratio me-1" style={{ '--bs-aspect-ratio': '50%' }}>
      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Vertical Stacking </div>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Horizontal Stacking </div>
            </Card.Header>
            <Card.Body>
      ...
      <Row className="row-sm">
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Vstack For Buttons </div>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Inline Form With Hstack </div>
            </Card.Header>
            <Card.Body>
              <div className="hstack gap-3">
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Text Truncation </div>
            </Card.Header>
            <Card.Body>
              <Row>
              ...
              {/* <!-- Inline level --> */}
              <span className="d-inline-block text-truncate" style={{ maxWidth: "150px" }}> This text is quite long, and will be truncated once displayed. </span>
            </Card.Body>
          </Card>
        </Col>
      </Row>

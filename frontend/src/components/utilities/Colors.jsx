...
const Colors = () => {
  ...
  return (
    <Fragment>
      <Pageheader mainheading='Colors' parentfolder='Utilities' activepage='Colors' />
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Text Colors </div>
            </Card.Header>
            <Card.Body>
              <Row className="row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  <div className="m-2 text-primary fw-semibold fs-14 text-center">primary</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-primary</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-secondary fw-semibold fs-14 text-center">secondary</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-secondary</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-warning fw-semibold fs-14 text-center">warning</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-warning</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-info fw-semibold fs-14 text-center">info</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-info</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-success fw-semibold fs-14 text-center">success</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-success</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-danger fw-semibold fs-14 text-center">danger</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-danger</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-light bg-dark fw-semibold fs-14 text-center">light</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-light</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 text-dark fw-semibold fs-14 text-center">dark</div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.text-dark</code></p>
                </div>
                <div className="p-3 col">
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Callout </div>
            </Card.Header>
            <Card.Body>
              <div className="callout">Lorem ipsum dolor sit amet consectetur adipisicing elit. </div>
              <div className="callout callout-info">Lorem ipsum dolor sit amet consectetur adipisicing elit. </div>
              <div className="callout callout-warning">Lorem ipsum dolor sit amet consectetur adipisicing elit. </div>
              <div className="callout callout-danger">Lorem ipsum dolor sit amet consectetur adipisicing elit. </div>
            </Card.Body>
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col lg={12} sm={6}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Background Colors </div>
            </Card.Header>
            <Card.Body>
              <Row className="row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  <div className="m-2 bg-primary mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-primary</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-secondary mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-secondary</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-warning mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-warning</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-info mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-info</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-success mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-success</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-danger mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-danger</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-light mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-light</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-dark mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-dark</code></p>
                </div>
              </Row>
            </Card.Body>
          </Card>
            ...
            <Card.Body>
              <Row className="row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  ...
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-primary-gradient</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-secondary-gradient mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-secondary-gradient</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-warning-gradient mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-warning-gradient</code></p>
                </div>
                <div className="p-3 col">
                ...
                <div className="p-3 col">
                  ...
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-success-gradient</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-danger-gradient mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-danger-gradient</code></p>
                </div>
                <div className="p-3 col">
        ...
        <div className="col-lg-12 col-sm-6">
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Background transparent colors </div>
            </Card.Header>
            <Card.Body>
              <Row className="row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  <div className="m-2 bg-primary-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-primary-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-secondary-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-secondary-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-warning-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-warning-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-info-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-info-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-success-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-success-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-danger-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-danger-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-light-transparent mx-auto color-container border"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-light-transparent</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-dark-transparent mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-dark-transparent</code></p>
                </div>
              </Row>
            </Card.Body>
          </Card>
            ...
            <Card.Body>
              <Row className="row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  ...
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-primary</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-secondary mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-secondary</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-warning mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-warning</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-info mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-info</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-success mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-success</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-danger mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-danger</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-light mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-light</code></p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 border border-dark mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center"><code>.border-dark</code></p>
                </div>
              </Row>
            </Card.Body>
          </Card>
        ...
        <div className="col-lg-12 col-sm-6">
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Background Opacity </div>
            </Card.Header>
            <Card.Body>
              <Row className="row-cols-12 d-flex align-items-center">
                <div className="p-3 col">

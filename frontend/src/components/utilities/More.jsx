...
const More = () => {
  return (
    <Fragment>
      <Pageheader mainheading='More' parentfolder='Utilities' activepage='More' />
          ...
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Display Inline </div>
                </Card.Header>
                <Card.Body>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> D-block </div>
                </Card.Header>
                <Card.Body>
        ...
        <Col xl={4}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Float </div>
                </Card.Header>
                <Card.Body>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                ...
                <Card.Body>
                  <div className="float-sm-start p-1 bg-light">Float sm </div> <br />
                  <div className="float-md-end p-1 bg-light">Float md </div> <br />
                  <div className="float-lg-start p-1 bg-light">Float lg </div> <br />
        ...
        <Col xl={4}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Text selection </div>
                </Card.Header>
                <Card.Body>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Pointer events </div>
                </Card.Header>
                <Card.Body>
                  <p><Link to="#" className="pe-none" tabIndex={-1}><code className="text-primary fw-semibold">This link</code></Link> can not be clicked. </p>
                  <p><Link to="#" className="pe-auto"><code className="text-primary fw-semibold">This link</code></Link> can be clicked (this is default behavior). </p>
                  <p className="pe-none mb-0"><Link to="#" tabIndex={-1}><code>This link</code></Link> can not be clicked because the <code className="text-primary fw-semibold">pointer-events</code> property is inherited from its parent. However, <Link to="#" className="pe-auto">this link</Link> has a
        ...
        <Col xl={6}>
          <Row>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Overflow </div>
                </Card.Header>
        ...
        <Col xl={6}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Vertical alignment With table cells </div>
                </Card.Header>
                <Card.Body>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Vertical alignment With inline elements </div>
                </Card.Header>
                <Card.Body>
                  <span className="me-1 align-baseline">baseline</span>
                  <span className="me-1 align-top">top</span>
                  <span className="me-1 align-middle">middle</span>
                  <span className="me-1 align-bottom">bottom</span>
                  <span className="me-1 align-text-top">text-top</span>
                  <span className="me-1 align-text-bottom">text-bottom</span>
                </Card.Body>
              </Card>
            </Col>
          </Row>
        ...
        <Col xl={6}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                ...
                <div className="card-body d-sm-flex">
                  <div className="opacity-100 p-3 m-2 bg-primary text-fixed-white fw-bold rounded">100% </div>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <div className='card-title'> Horizontal centering </div>
                </Card.Header>
                <Card.Body>
      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <div className='card-title'> Relative to the parent </div>
            </Card.Header>
            <Card.Body>
              <div className="mb-5">
              ...
              <div style={{ height: "100px", backgroundColor: "rgba(255,0,0,0.1)" }} className="d-flex">
                <div className="h-25 d-inline-block p-1" style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}>Height 25% </div>
                <div className="h-50 d-inline-block p-1" style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}>Height 50% </div>
                <div className="h-75 d-inline-block p-1" style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}>Height 75% </div>
                <div className="h-100 d-inline-block p-1" style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}>Height 100% </div>
                <div className="h-auto d-inline-block p-1" style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}>Height auto </div>
              </div>
            </Card.Body>
          </Card>
        </Col>
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <div style={{ height: "100px", backgroundColor: "rgba(255,0,0,.1)" }} className="mt-3">
                <div className="mh-100 p-2" style={{ width: "100px", height: "200px", backgroundColor: "rgba(0,0,255,.1)" }}> Max-height 100%</div>
              </div>
            </Card.Body>
          </Card>
        </Col>

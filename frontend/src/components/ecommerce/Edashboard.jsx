...
import { ProductsDetails } from "../../common/Comondata";
import { RecentOrder, RevenueChart } from "../../common/Chartdata";
...
const ECDashboard = () => {
  return (
    <Fragment>
      <Pageheader mainheading='Welcome To Dashboard' parentfolder='ECommerce' activepage='Dashboard' />
            ...
            <div className="product-timeline card-body pt-3 mt-1">
              <ul className="timeline-1 mb-0">
                <li className="mt-0">
                  ...
                  <Link to="#" className="float-end fs-11 text-muted">
                    3 days ago
                  </Link>
              ...
              <ul className="top-selling-products pb-0 mb-0 ps-0">
                <li className="product-item">
                  <div className="product-img">
                    <img src={ALLImages('png14')} alt="png14" />
                  </div>
                ...
                <li className="product-item">
                  <div className="product-img">
                    <img src={ALLImages('png18')} alt="png18" />
                  </div>
                  <div className="product-info">
                ...
                <li className="product-item">
                  <div className="product-img">
                    <img src={ALLImages('png17')} alt="png17" />
                  </div>
                  <div className="product-info">
                ...
                <li className="product-item">
                  <div className="product-img">
                    <img src={ALLImages('png16')} alt="png16" />
                  </div>
                  <div className="product-info">
                ...
                <li className="product-item pb-0">
                  <div className="product-img">
                    <img src={ALLImages('png19')} alt="png19" />
                  </div>
                  <div className="product-info">
            ...
            <Card.Body className="pt-0 pb-3 row">
              <Col xl={8} className="col-xl-8">
                <div id="world-map-markers" className="ht-300">
                  {/* <EcommerceMap /> */}
                  <WorldMap tooltip='on' landColor='#cfcdef' hoverColor='#6058c7' landBorder='#6259ca' tooltipBgColor='#000' tooltipTextColor='#fff' onCountryClick={() => { }} />
                </div>
              </Col>
          ...
          <Card className=" custom-card overflow-hidden">
            <Card.Header className="border-bottom-0 d-flex">
              ...
              <Dropdown className="card-options float-end">
                <Dropdown.Toggle
                  className="me-0 text-default no-caret"
                  role="button"
                  variant="default"
            ...
            <div className="card-body pt-0">
              <div className="border">
                <div className="list-group projects-list pt-0 pb-0 ps-0 pe-0">
                  <Link to="#" className="list-group-item list-group-item-action flex-column align-items-start border-0">
                  ...
                  <Link to="#" className="list-group-item list-group-item-action flex-column align-items-start border-bottom-0  border-start-0 border-end-0 border-top">
                    <div className="d-flex w-100 justify-content-between">
                  ...
                  <Link to="#" className="list-group-item list-group-item-action flex-column align-items-start border-start-0 border-end-0 border-0 border-top">
                    <div className="d-flex w-100 justify-content-between">

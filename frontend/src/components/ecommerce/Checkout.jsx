...
import { Country, State } from "../../common/Select2data";
...
const Checkout = () => {
  ...
  return (
    <Fragment>
      <Pageheader mainheading='Checkout' parentfolder='ECommerce' activepage='Checkout' />
                    ...
                    <Tab.Content className="border m-4">
                        ...
                        <div className="your-order" id="shipped-tab-pane">
                          ...
                          <div className="product">
                            <div className="item flex-wrap px-4 gap-2">
                              <div className="left flex-wrap gap-2"> <Link to="#" className="thumb rounded-3"> <img src={ALLImages('ecommerce11')} alt="" className="rounded-3" /> </Link>
                                <div className="purchase">
                                  <h6> <Link to="#">Sofa chair</Link> </h6>
                            ...
                            <div className="item flex-wrap px-4 gap-2 mb-0">
                              <div className="left flex-wrap gap-2"> <Link to="#" className="thumb rounded-3"> <img src={ALLImages('ecommerce15')} alt="" className="rounded-3" /> </Link>
                                <div className="purchase">
                                  <h6> <Link to="#">white Shoes</Link> </h6>
                                  <div className="d-flex flex-wrap mt-2">
                                    <div className="mt-2 product-title fs-12 me-2">Quantity:</div>
                                    <div className="handle-counter input-group border rounded flex-nowrap">
                      ...
                      <Tab.Pane className="fade border-0 p-0" eventKey="fifth">
                        ...
                        <div className="px-4 py-3 border-top border-block-start-dashed d-flex justify-content-between">
                          ...
                          <Link to={`${import.meta.env.BASE_URL}ecommerce/orders/`} className="btn btn-secondary m-1">Order Again</Link>
                        </div>
                      </Tab.Pane>
                    </Tab.Content>
                  </Col>

...
const B2bChatComponent = ({
  ...
  const scrollToBottom = () => {
    ...
    if (unreadMessages.length > 0 && socket) {
      ...
      console.log("message_readUserId", messageIds, userId);
                                      ...
                                      {m.type.startsWith("image/") ? (
                                        <div className="image-container">
                                          <img
                                            ...
                                            onClick={() =>
                                              handleImageClick(m.url, m.name)
                                            }
                                          />
                                          <FaDownload
                                            className="image-download-btn"
                                            onClick={() =>
                                              handleDownload(m.url, m.name)
                                            }
                                          />
                                        </div>
                                      ) : (
              ...
              <div className="main-chat-footer">
                <Nav>
                  {/* <OverlayTrigger overlay={<Tooltip>Add Photo</Tooltip>}>
                      <Nav.Link><i className="fe fe-image"></i></Nav.Link>
                    </OverlayTrigger> */}
                  <OverlayTrigger overlay={<Tooltip>Attach a File</Tooltip>}>
                    <Nav.Link onClick={() => fileInputRef.current?.click()}>
                      <i className="fe fe-paperclip me-3"></i>
                    </Nav.Link>
                  </OverlayTrigger>
                  {/* <OverlayTrigger overlay={<Tooltip>Emoji</Tooltip>}>
                      <Nav.Link><i className="far fa-smile"></i></Nav.Link>
                    </OverlayTrigger>
                    <OverlayTrigger overlay={<Tooltip>Record Voice</Tooltip>}>
                      <Nav.Link><i className="fe fe-mic"></i></Nav.Link>
                    </OverlayTrigger> */}
                </Nav>
                <input
                  type="file"
...
export default B2bChatComponent;

...
const FranceVisaFeePayment = ({ id }) => {
  ...
  const documentTypes = ["Receipt Visa Fee Payment"];
  ...
  const paymentOptions = [
    ...
    { value: "Cash at VFS", label: "Cash at VFS" },
  ];
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        ...
        if (values.receiptUpload) {
          ...
          formData.append("customDocumentName", "Receipt Visa Fee Payment");
          formData.append(
            "ref_module",
  ...
  useEffect(() => {
    if (applicationData?.visaApplicationDetails?.visaFeePayment) {
      const visaFeePayment =
        applicationData.visaApplicationDetails.visaFeePayment;
      formik.setValues({
        amount: visaFeePayment.amount ? visaFeePayment.amount : "",
        ...
        <div className="bg-white mt-3 p-3">
          <Form onSubmit={formik.handleSubmit}>
            <Row>
              ...
              <Col md={6} className="mb-3">
                <Form.Group>
                  <Form.Label>Upload Visa Fee Receipt (PDF/JPG/PNG)</Form.Label>
                  <Form.Control
                    type="file"
                    name="receiptUpload"
                    ...
                    disabled={
                      applicationData?.uploadedDocumentDetails?.some(
                        (doc) =>
                          doc.customDocumentName === "Receipt Visa Fee Payment"
...
export default FranceVisaFeePayment;

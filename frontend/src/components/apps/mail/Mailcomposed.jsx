...
import { Card, Col, Form, Nav, OverlayTrigger, Row, Button, Tooltip } from "react-bootstrap";
import Pageheader from "../../../layouts/Pageheader";

const Mailcomposed = () => {
  return (
    <Fragment>
      <Pageheader mainheading='Mail-Compose' parentfolder='Mail' activepage='Mail-Compose' />
              ...
              <Form>
                <Form.Group className="form-group">
                  <div className="row align-items-center">
                    <Form.Label className="col-sm-3 col-xl-2  tx-semibold text-muted">
                      To
                    </Form.Label>
                ...
                <Form.Group className="form-group">
                  <div className="row">
                    <Form.Label className="col-sm-3 col-xl-2 form-label tx-semibold text-muted">
                      Message
                    </Form.Label>
                    <div className="col-sm-9 col-xl-10">

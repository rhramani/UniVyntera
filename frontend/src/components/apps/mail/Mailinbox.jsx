...
import { Col, Dropdown, Row, Card, Nav, Table, Form } from "react-bootstrap";
...
const Mailinbox = () => (
  <Fragment>
    <Pageheader mainheading='Mail-Inbox' parentfolder='Mail' activepage='Mail-Inbox' />
        ...
        <Card className=" custom-card mail-container task-container overflow-hidden">
          <div className="">
            <div className="p-4 border-bottom d-grid">
              <Link to={`${import.meta.env.BASE_URL}apps/mail/mailcomposed/`} className="btn btn-primary btn-compose" id="btnCompose"> Compose </Link>
            </div>
          ...
          <div className="inbox-body p-4">
            <div className="mail-option d-sm-flex justify-content-between align-items-start">
              <div>
                <div className="chk-all border-0">
                  <div className="btn-group">
                    <Dropdown className="mini all">
                      <Dropdown.Toggle className="no-caret btn btn-outline-light" variant="" id="dropdown-basic">All <i className="fe fe-chevron-down"></i></Dropdown.Toggle>
                      <Dropdown.Menu>
                ...
                <div className="btn-group hidden-phone  ms-2">
                  <Dropdown className="mini all">
                      <Dropdown.Toggle className="no-caret btn btn-outline-light" variant="" id="dropdown-basic">More <i className="fe fe-chevron-down"></i></Dropdown.Toggle>
                      <Dropdown.Menu>
                        <Dropdown.Item href="#/action-1"><i className="fe fe-edit me-2"></i> Mark as Read</Dropdown.Item>
                        <Dropdown.Item href="#/action-2"><i className="fe fe fe-slash me-2"></i> Spam</Dropdown.Item>
                        <Dropdown.Divider />
              ...
              <ul className="unstyled inbox-pagination ps-0 mt-2 mt-sm-0">
                ...
                <li>
                  <Link className="btn np-btn" to="#"><i className="fe fe-chevron-right pagination-right"></i></Link>
                </li>
              </ul>
            </div>

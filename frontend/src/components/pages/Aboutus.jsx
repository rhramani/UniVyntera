...
const Aboutus = () => {
  return (
  <Fragment>
      <Pageheader mainheading='About Us' parentfolder='Pages' activepage='About Us' />
    <Container>
      ...
      <Row className="row-sm">
        <Col xl={12}>
          <Card className="custom-card">
            <img src={ALLImages("blog16")} alt="img" className="rounded-3" />
          </Card>
        </Col>
      </Row>
      <Row className="row-sm">
          ...
          <Row className="row-sm">
            ...
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="text-xl-end text-center">
                <img src={ALLImages("png30")} alt="img" className="rounded-5" />
              </div>
            </Col>
          </Row>
        </Col>
      ...
      <Row className="row-sm">
          ...
          <Card className="custom-card our-team">
            <Card.Body>
              ...
              <div className="text-center mt-3">
                <Link to="#"> <h5 className="pro-user-username text-dark mt-2 mb-0"> Dennis Trexy </h5> </Link>
              ...
              <div className="text-center mt-3">
                <Link to="#" className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1"> <i className="mdi mdi-facebook"></i></Link>
                <Link to="#" className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1"> <i className="mdi mdi-google"></i> </Link>
                <Link to="#" className="btn btn-sm ripple bg-info-transparent text-info rounded-circle"> <i className="ri-twitter-x-fill"></i> </Link>
              </div>
            </Card.Body>
          </Card>
        </Col>
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              <div className="picture avatar-lg online text-center">
                <img alt="avatar" className="rounded-circle" src={ALLImages("face1")} />
              </div>
              <div className="text-center mt-3">
                <Link to="#"> <h5 className="pro-user-username text-dark mt-2 mb-0">Benedict Vallone</h5> </Link>
        ...
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              ...
              <div className="text-center mt-3">
                <Link to="#"> <h5 className="pro-user-username text-dark mt-2 mb-0"> Robbie Ruder </h5> </Link>
                <p className="pro-user-desc text-muted mb-1">Web Developer</p>
                <div className="text-center tx-14 mb-3">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Quibusdam !
        ...
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              <div className="picture avatar-lg online text-center">
                <img alt="avatar" className="rounded-circle" src={ALLImages("face8")} />
              </div>
              <div className="text-center mt-3">
                <Link to="#"> <h5 className="pro-user-username text-dark mt-2 mb-0"> Mariane Galeon </h5> </Link>
                <p className="pro-user-desc text-muted mb-1">Web Designer</p>
                <div className="text-center tx-14 mb-3">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Quibusdam !

...
const Messagesuccess = () => {
  return (
    <Fragment>
      <div className="page main-signin-wrapper bg-primary br-0-f text-center">
            ...
            <Card className="alert-message">
              <Card.Body>
                <div className="text-center text-white">
                  ...
                  <h3 className="mt-4 mb-3 text-fixed-white">Message success</h3>
                  <p className="fs-18 text-white-50">Oops!! You tried to access a page which is not available.</p>
                  <Link to={`${import.meta.env.BASE_URL}dashboard/dashboard`} className="btn btn-success">Back to Home</Link>
                </div>
              </Card.Body>
            </Card>
          </Col>

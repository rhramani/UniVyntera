...
exports.getTemplates = async (category) => {
  ...
  const url = `${config.baseUrl}/${config.apiVersion}/${config.wabaId}/message_templates?limit=1000`;
  try {
...
exports.createTemplate = async (data) => {
  ...
  const url = `${config.baseUrl}/${config.apiVersion}/${config.phoneNumberId}/message_templates`;
...
exports.deleteTemplate = async (templateName) => {
  ...
  try {
    const response = await axios.delete(
      `${config.baseUrl}/${config.apiVersion}/${config.phoneNumberId}/message_templates`,
      {

...
const Institute = require("../../../model/masters/directInstitute");
  ...
  getAllInstitutes: async (
    ...
    if (status) {
          ...
          if (status === "notExpired") {
            query.agreementEndDate = { $gte: today };
          }
    
          if (status === "expired") {
            query.agreementEndDate = { $lt: today };
          }
    
          if (status === "expiringInMonth") {
            query.agreementEndDate = { $gte: today, $lte: nextMonth };
          }
        }

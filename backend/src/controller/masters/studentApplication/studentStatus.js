const studentStatusService = require("../../../services/masters/studentApplication/studentStatus");

const studentStatusController = {
  create: async (req, res) => {
    try {
      const newStatus = await studentStatusService.create(req.body, req.user?.userId , req.user?.userName);
  ...
  getAll: async (req, res) => {
    try {
      const statuses = await studentStatusService.getAll(req.query.search);
  ...
  getById: async (req, res) => {
    try {
      const status = await studentStatusService.getById(req.params.id);
  ...
  update: async (req, res) => {
    try {
      const updated = await studentStatusService.update(req.params.id, req.body, req.user?.userId, req.user?.userName);
  ...
  deleteStatus: async (req, res) => {
    try {
      const deleted = await studentStatusService.delete(req.params.id);
